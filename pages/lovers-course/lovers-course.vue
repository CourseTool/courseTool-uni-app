	...
	<view class="lovers-course" v-if="isShowPage">
		<div class="header">
			<div class="male">
				...
				<select-class v-if="isShowMaleSelectClass" type="student"
					@hide-select-class="selectMaleClass"></select-class>
			</div>
			<div class="icon">
			...
			<div class="female">
				...
				<select-class v-if="isShowFemaleSelectClass" type="student"
					@hide-select-class="selectFemaleClass"></select-class>
			</div>
		</div>
				...
				<div class="course" v-for="(d,i) in data">
					...
					<div class="bottom-course" :class="{female:d.courseClass===femaleClass}">
						...
						<div class="icon" v-if='i===1'>
							<uni-icons style="margin-right: -30rpx;" color="#6598d9" type="heart-filled"
								size="26"></uni-icons>
							<uni-icons color="#FFCCE1" type="heart-filled" size="26"></uni-icons>
						</div>
						<div class="position">
...
<script setup>
	...
	async function getCourse() {
		...
		console.log(courseDataList.value);
		uni.hideLoading()
