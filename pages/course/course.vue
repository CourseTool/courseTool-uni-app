		...
		<div class="course-tools">
			<div class="class">
				<div class="title">
					...
					<span @click="isShowSelectClass=true">{{indexData.className}}<span
							style="text-decoration: underline;">(更改)</span></span>
					<span style='text-decoration: underline;' @click="gotoCurrentDay">今天</span>
				</div>
				<select-class type="student" @hide-select-class="hiddenSelectClass"
					v-if="isShowSelectClass"></select-class>
			</div>
			<div class="week-day">
		...
		<div @touchstart="touchStart" @touchend='silder' class="course-content">
			...
			<div v-else class="course-list">
				...
				<div class="course-item" v-for='data in courseData.courseList' :key='data.id'>
					<div class="title">
						<image style='width:35rpx;height:35rpx;margin-right:10rpx' src="../../static/时钟.png" mode="">
						</image>
...
<script setup>
	...
	import {
		...
		getStudentWeekHasCourseDayListAPI
	} from '@/API/course.js'
	import {
		ref,
		reactive,
	...
	function gotoCurrentDay() {
		...
		indexData.week = week
		indexData.weekDay = weekDay
		indexData.className = uni.getStorageSync("home-active-type") === "student" ? uni.getStorageSync(
				"home-active-val") :
			"软件2303班"
