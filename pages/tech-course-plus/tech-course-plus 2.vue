...
<script setup>
	...
	// function sortTeacherCourseWeekDay() {
	// 	weekCourseList.value.sort((a, b) => {
	// 		return weekDaySortIndex[b.courseWeekDay] - weekDaySortIndex[a.courseWeekDay]
	// 	})
	// }
	...
	onMounted(() => {
		initWeekList()
		indexData.value.teacherName = uni.getStorageSync("home-active-type") === "teacher" ? uni.getStorageSync(
			'home-active-val') : "吴宇飞"
		weekDayList.value = getDateByWeek(weekIndex.value + 1)
	})
</script>
