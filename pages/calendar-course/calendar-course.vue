<template>
	<view class="calendar-course" v-if="isShowPage">
		...
		<div class="course-list">
			...
			<div v-if="courseDataList.courseList.length !== 0" class="course-item"
				v-for="d in courseDataList.courseList" :key="d.id">
...
<script setup>
	...
	function fillCalendar() {
		...
		for (let i = 1; i <= monthMap[month]; i++) {
			...
			console.log(d, hasCourseDayList.value);
